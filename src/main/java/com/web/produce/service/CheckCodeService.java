...
public interface CheckCodeService {
	...
	public ApiResponseResult getHistoryList(String keyword,Integer errFlag, String hStartTime,String hEndTime, String scanType, String scanFrom,String barCode,PageRequest pageRequest) throws Exception;

	public void exportExcel(HttpServletResponse response,String keyword, Integer errFlag, String hStartTime, String hEndTime, String scanType, String scanFrom,String barCode, PageRequest pageRequest) throws Exception;
