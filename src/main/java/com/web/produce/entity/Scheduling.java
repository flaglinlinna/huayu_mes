...
public class Scheduling extends BaseEntity {
     ...
     * 部门ID
     */
    @ApiModelProperty(name = "bsDepartId", value = "部门ID")
    @Column
    protected Long bsDepartId;
     ...
     * 加工工艺ID（工序ID）
     */
    @ApiModelProperty(name = "bsProcId", value = "加工工艺ID（工序ID）")
    @Column
    ...
    @Column
    protected String bsActualHours;
    ...
    public Long getBsDepartId() {
        return bsDepartId;
    }

    public void setBsDepartId(Long bsDepartId) {
        this.bsDepartId = bsDepartId;
    }
    ...
    public String getBsPlanHours() {
        return bsPlanHours;
    }

    public void setBsPlanHours(String bsPlanHours) {
    ...
    public String getBsActualHours() {
        return bsActualHours;
    }

    public void setBsActualHours(String bsActualHours) {
