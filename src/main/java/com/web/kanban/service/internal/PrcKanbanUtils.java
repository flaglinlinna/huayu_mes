...
public class PrcKanbanUtils {
	...
	// 获取车间报工看板信息
	public List getCjbgListPrc(String company, String facoty, String user_id, String class_id, String dep_id,
			String sdata, String dev_ip) throws Exception {
	...
	// 获取生产电子看板信息
	public List getScdzListPrc(String company, String facoty, String user_id, String class_id, String dep_id,
			String sdata, String dev_ip) throws Exception {
		List resultList = (List) jdbcTemplate.execute(new CallableStatementCreator() {
			@Override
			public CallableStatement createCallableStatement(Connection con) throws SQLException {
	...
	public List getScdzDetailListPrc(String user_id, String liner, String dep_id, String dev_ip, String fieldword)
			throws Exception {
		List resultList = (List) jdbcTemplate.execute(new CallableStatementCreator() {
			@Override
			public CallableStatement createCallableStatement(Connection con) throws SQLException {
	...
	// 获取制程不良看板信息
	public List getZcblListPrc(String company, String facoty, String user_id, String class_id, String dep_id,
			String sdata, String dev_ip) throws Exception {
		List resultList = (List) jdbcTemplate.execute(new CallableStatementCreator() {
			@Override
			public CallableStatement createCallableStatement(Connection con) throws SQLException {
	...
	// 获取效率排名看板
	public List getXlpmListPrc(String company, String facoty, String user_id, String class_id, String dep_id,
	...
	// 获取产线电子看板
	public List getCxdzListtPrc(String company, String facoty, String user_id, String class_id, String dep_id,
			String sdata, String dev_ip, String liner) throws Exception {
		List resultList = (List) jdbcTemplate.execute(new CallableStatementCreator() {
			@Override
			public CallableStatement createCallableStatement(Connection con) throws SQLException {
	...
	// 获取待返工看板信息
	public List getDfgListPrc(String company, String facoty, String user_id, String class_id, String dep_id,
			String sdata, String dev_ip) throws Exception {
		List resultList = (List) jdbcTemplate.execute(new CallableStatementCreator() {
			@Override
			public CallableStatement createCallableStatement(Connection con) throws SQLException {
	...
	// 获取产线生产看板
	public List getCxscList(String company, String facoty, String taskNo, String deptId, String liner, String dev_ip,
			String usr_id, String interval) throws Exception {
		List resultList = (List) jdbcTemplate.execute(new CallableStatementCreator() {
			@Override
			public CallableStatement createCallableStatement(Connection con) throws SQLException {
	...
	// 获取所有制令单的时间段
	public List getCxscList2Prc(String company, String facoty, String taskNo, String deptId, String liner,
			String dev_ip, String usr_id, String interval) throws Exception {
		List resultList = (List) jdbcTemplate.execute(new CallableStatementCreator() {
			@Override
			public CallableStatement createCallableStatement(Connection con) throws SQLException {
	...
	public List getZxllListPrc(String company, String facoty, String class_id, String deptId, String date,
			String dev_ip, String usr_id) throws Exception {
		List resultList = (List) jdbcTemplate.execute(new CallableStatementCreator() {
			@Override
			public CallableStatement createCallableStatement(Connection con) throws SQLException {
				String storedProc = "{call prc_mes_rpt_cj_qc_rate (?,?,?,?,?,?,?,?,?,?,?,?,?)}";// 调用的sql
				CallableStatement cs = con.prepareCall(storedProc);
				cs.setString(1, company);// -公司
				cs.setString(2, facoty);// 工厂
				cs.setString(3, class_id);// 班次
				cs.setString(4, deptId);// --部门ID*
				cs.setString(5, date);// -日期
				cs.setString(6, dev_ip);// 电视IP或mac*
				cs.setString(7, usr_id);// 用户id*
				cs.registerOutParameter(8, java.sql.Types.INTEGER);// 输出参数 返回标识
				cs.registerOutParameter(9, java.sql.Types.VARCHAR);// 输出参数 返回标识
	...
	public List getFinishRatePrc(String company, String facoty, String taskNo, String deptId, String liner,
			String dev_ip, String usr_id, String interval) throws Exception {
		List resultList = (List) jdbcTemplate.execute(new CallableStatementCreator() {
			@Override
			public CallableStatement createCallableStatement(Connection con) throws SQLException {
				String storedProc = "{call prc_mes_rpt_line_tab (?,?,?,?,?,?,?,?,?,?,?,?)}";// 调用的sql
				CallableStatement cs = con.prepareCall(storedProc);
				cs.setString(1, company);// -公司
				cs.setString(2, facoty);// 工厂
				cs.setString(3, taskNo);// 班次
