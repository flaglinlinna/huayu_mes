...
$(function() {
	layui.use([ 'form', 'table' ], function() {
		...
		function getUnit(obj, id) {
			...
			CoreUtil.sendAjax("/basePrice/unit/getUnitDetail", JSON.stringify(param),
					function(data) {
						if (data.result) {
							form.val("unitForm", {
									"id": data.data.id,
...
function addSubmit(obj) {
	CoreUtil.sendAjax("/basePrice/unit/add", JSON.stringify(obj.field), function(
			data) {
		if (data.result) {
...
function editSubmit(obj) {
	CoreUtil.sendAjax("/basePrice/unit/edit", JSON.stringify(obj.field), function(
			data) {
		if (data.result) {
			layer.alert("操作成功", function() {
				layer.closeAll();
...
function delUnit(obj, id, name) {
	if (id != null) {
		...
		// 按钮
			...
			CoreUtil.sendAjax("/basePrice/unit/delete", JSON.stringify(param),
					function(data) {
						if (isLogin(data)) {
							if (data.result == true) {
								// 回调弹框
