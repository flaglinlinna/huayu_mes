	...
	layui.use([ 'form', 'table','upload','tableSelect' ], function() {
		...
		tableIns = table.render({
			...
			cols : [ [ {type : 'numbers',style:'background-color:#d2d2d2'},
				...
				{field : 'bsRadix', title : '基数<span style="color:red;font-size:12px;">*</span>',width:90,edit:'text'},
				{field : 'bsUserNum', title : '人数<span style="color:red;font-size:12px;">*</span>',width:90,edit:'text',hide:true},
				{field : 'bsCycle', title : '成型周期(S)<span style="color:red;font-size:12px;">*</span>', width:150,edit:'text', hide:true},
				{field : 'bsYield', title : '工序良率%<span style="color:red;font-size:12px;">*</span>', width:120,edit:'text',hide:true},
				{field : 'bsLoss', title : '损耗率<span style="color:red;font-size:12px;">*</span>', width:100,edit:'text',hide:true},
				{field : 'bsCave', title : '穴数<span style="color:red;font-size:12px;">*</span>',edit:'text',width:90, hide:true},
				{field : 'bsCapacity', title : '产能<span style="color:red;font-size:12px;">*</span>',edit:'text',width:90, hide:true},
