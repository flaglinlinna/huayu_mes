...
$(function() {
	layui.use([ 'table', 'form', 'layedit', 'laydate', 'layer' ,'tableFilter'], function() {
		...
		tableIns = table.render({
			elem : '#listTable',
			url : context + '/quoteItem/getList?quoteId='+quoteId,
			method : 'get', // 默认：get请求
		...
		table.on('tool(listTable)', function(obj) {
			...
			if (obj.event === 'del') {
				...
				parent.layui.index.openTabsPage(context + '/quoteItem/toQuoteItemList?quoteId=' + data.id, '虚拟料号对应');
		...
		$("#ul-list li").click(function() {
			...
			tableIns.reload({
				url : context + '/quoteItem/getList?quoteId='+quoteId+'&bsStatus=' + $("span:last", this).attr("data-status"),
			// url:context +
