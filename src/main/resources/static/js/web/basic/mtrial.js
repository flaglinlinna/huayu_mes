	...
	layui.use([ 'form', 'table' ], function() {
		...
		tableIns = table.render({
			...
			cols : [ [ {fixed:'left',type : 'numbers'},
			 	{fixed:'left',field : 'itemNo', title : '物料编码', width : 150, sort: true},
				{fixed:'left',field : 'itemName', title : '物料名称', width : 180},
				{fixed:'left',field : 'itemType', title : '物料类别', width : 110},
				{field : 'itemUnit', title : '物料单位', width : 80},
