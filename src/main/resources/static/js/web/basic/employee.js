...
$(function() {
	layui.use([ 'form', 'table' ], function() {
		...
		function getEmployee(obj, id) {
			...
			CoreUtil.sendAjax("base/employee/getEmployee", JSON.stringify(param),
					function(data) {
						if (data.result) {
...
function editSubmit(obj) {
	CoreUtil.sendAjax("base/employee/edit", JSON.stringify(obj.field), function(
			data) {
		if (data.result) {
			layer.alert("操作成功", function() {
				layer.closeAll();
