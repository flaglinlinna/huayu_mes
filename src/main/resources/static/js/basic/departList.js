...
function addSubmit(obj) {
	CoreUtil.sendAjax("base/depart/add",JSON.stringify(obj.field),function (data) {
		if (data.result) {
			layer.alert("操作成功", function() {
				layer.closeAll();
				cleanDepartment();
...
function getDepart(obj, id) {
	...
	CoreUtil.sendAjax("base/depart/getDepart", JSON.stringify(param), function(
			data) {
		if (data.result) {
			...
			$("#bsManager").val(
					data.data.bsManager == null ? '' : data.data.bsManager);
			$("#bsManagerTel").val(
					data.data.bsManagerTel == null ? ''
							: data.data.bsManagerTel);
...
function editSubmit(obj) {
	CoreUtil.sendAjax("base/depart/edit",JSON.stringify(obj.field),function (data) {
		if (data.result) {
			layer.alert("操作成功", function() {
				layer.closeAll();
				cleanDepartment();
